...
import type { RoleConfig } from "../../hooks/useForm"; // 🧩 gunakan tipe dari hook
...
interface FormPreviewCardProps {
	...
	selectedStaff: Staff[];
	config: RoleConfig;
	onToggleRoleFill: (role: string) => void;
	onToggleRoleView: (role: string) => void;
	onToggleFillablePosition: (posId: string) => void;
	onToggleViewablePosition: (posId: string) => void;
}
...
function AccessColumn({
	...
	return (
		<div className="space-y-4">
			...
			{/* Position selector (hanya jika role 'staff' dipilih) */}
