---
title : Work Order - Memberships (otomatis)
description: Proses bisnis work order dengan konfigurasi otomatis untuk anggota memberships
order: 
---

## Perbarui konfigurasi layanan
Perbarui konfigurasi layanan dengan tipe layanan otomatis (publik). Menjadi tipe layanan otomatis (memberships)
...
variant: info
title: Informasi
message: Repeat Flow Work Order Otomatis "Proses Permintaan Layanan" > "Proses Pengerjaan Laporan Perintah Kerja" > "Proses Review Permintaan Layanan"
```
